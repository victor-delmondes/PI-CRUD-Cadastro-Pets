        ...
        try {
            ...
            if (!rs.next()) {
                ...
                String[] script = {
                    ...
                    "ALTER TABLE `niveis` MODIFY `id_acesso` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1",
                    "ALTER TABLE `pets` MODIFY `id_pet` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1",
                    "ALTER TABLE `situacao` MODIFY `id_situacao` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1",
                    "ALTER TABLE `usuarios` MODIFY `id_user` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2",
